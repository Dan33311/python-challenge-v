...
def get_city_weather(city):
    ...
    return print(f'{temperature} degrees and {sky_condition}')


# TEST
def test_get_city_weather():
    print(" 🐉 function test_get_city_weather() running")
    # PASS YOUR PARAM INTO THE FUNCTION
    get_city_weather("Sao Paulo")
